...
describe Drink do
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      ...
      subject(:pepsi_zero) { described_class.new('Pepsi Zero') }

      # remove the 'x' before running this test
      it 'is full' do
        expect(pepsi_zero).to be_full
      end
    end
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:coke) { described_class.new('Coke', 8) }

      # remove the 'x' before running this test
      it 'is not full' do
        expect(coke).not_to be_full
      end
    end
  end
end
