...
describe NumberGame do
  ...
  describe '#initialize' do
    context 'when solution is initialized' do
      ...
      it 'is a number between 0 and 9' do
        solution = game.solution
        expect(solution).to be_between_zero_and_nine be true
      end
    end
  end
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        symbol = '@'
        valid = '5'
        allow(game_loop).to receive(:player_input).and_return(letter, symbol, valid)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      subject(:game) { described_class.new(5, '5', 10) }

      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        final_message = "That was hard. It took you 10 guesses!\n"
        expect { game.final_message }.to output(final_message).to_stdout
      end
    end
  end
end
