...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_not_over) { described_class.new(2, '5') }
      # remove the 'x' before running this test
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        invalid_input = 'I am invalid'
        verified_input = game_check.verify_input(invalid_input)
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        invalid2 = 'invalid 2'
        valid_input = '9'
        allow(game_loop).to receive(:player_input).and_return(invalid1, invalid2, valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      subject(:tough_game) { described_class.new(4, '4', 7) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        phrase = "That was hard. It took you 7 guesses!\n"
        expect { tough_game.final_message }.to output(phrase).to_stdout
      end
    end
  end
end
