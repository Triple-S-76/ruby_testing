...
describe MagicSeven do
  ...
  describe '#divide_by_two' do
    context 'when the previous step is 24' do
      it 'returns 12' do
        previous_step = 24
  ...
  describe '#play' do
    context 'when the random number is 55' do
      subject(:game_55) { described_class.new(55) }
    ...
    context 'when the random number is 100587' do
      subject(:game_100587) { described_class.new(100587) }
      # remove the 'x' before running this test
      it 'will return 7' do
        result = game_100587.play
        expect(result).to eq(7)
      end
    end

    context 'when the random number is 123,987,654' do
      subject(:game_big_number) { described_class.new(123_987_654) }
      # remove the 'x' before running this test
      it 'will return 7' do
        result = game_big_number.play
        expect(result).to eq(7)
      end
    end
  end
