...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      subject(:game1) { described_class.new(5, 9, number_guessing) }
      it 'returns 7' do
        expect(game1.make_guess).to eq(7)
      end
    end

    context 'when min is 8 and max is 9' do
      subject(:game2) { described_class.new(8, 9, number_guessing) }
      it 'returns 8' do
    ...
    context 'when min is 0 and max is 3' do
      subject(:game3) { described_class.new(0, 3, number_guessing) }
      it 'returns 1' do
    ...
    context 'when min and max both equal 3' do
      subject(:game4) { described_class.new(3, 3, number_guessing) }
      it 'returns 3' do
  ...
  describe '#game_over?' do
    ...
    let(:random_number) { double('random number double', value: 5) }
    ...
    context 'when guess and random_number are equal' do
      ...
      subject(:my_game) { described_class.new(0, 9, random_number, 5) }
      it 'is game over' do
    ...
    context 'when guess and random_number are not equal' do
      subject(:my_game_not_over) { described_class.new(0, 9, random_number, 8) }
      it 'is not game over' do
        expect(my_game_not_over).not_to be_game_over
      end
    end
  end
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      ...
      let(:random_number) { double('random number', value: 8) }
